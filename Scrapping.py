...
# Images
words_to_search = ['chapeau','cigarette', 'homme']
nb_to_download = [3,1,2]
first_image_position = [1,1,1]
...
def search_and_save(text, number, first_position):
    ...
    driver = webdriver.Chrome(executable_path='C:/Users/hp/Desktop/AGCA/chromedriver.exe')
    driver.get(url)
    headers = {}
